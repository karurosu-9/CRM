                            ...
                            <form @submit.prevent="storeCustomer">
                                <div class="container px-5 py-8 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <div v-if="errors.kana" style="color: red" >・{{ errors.kana }}</div>
                                            ...
                                            <div class="p-2 w-full">
                                            <div class="relative">
                                                <div v-if="errors.tel" style="color: red" >・{{ errors.tel}}</div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <div v-if="errors.postcode" style="color: red" >・{{ errors.postcode }}</div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <label for="address" class="leading-7 text-sm text-gray-600address">住所</label>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <div v-if="errors.birthday" style="color: red" >・{{ errors.birthday }}</div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <div v-if="errors.gender" style="color: red" >・{{ errors.gender }}</div>
                                                ...
                                                <label for="gender2" class="ml-2gender">その他</label>
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <div v-if="errors.memo" style="color: red" >・{{ errors.memo }}</div>
